...
double area(double radius) { //overloading function for finding the area of circle
	double area1;
	double input_radius;
...
double area(double sideA, double sideB) { //overloading function for finding the area of rectengle
	double area2;
	area2 = sideA * sideB;
...
double area(double sidetriangleA, double sidetriangleB, double sidetriangleC) { //overloading function for finding the area of triangle
   double area3,S;
